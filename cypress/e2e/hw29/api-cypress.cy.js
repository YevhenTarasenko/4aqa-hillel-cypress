...
describe('API cypress tests', () => {
	it('GET api test /users', () => {
		cy.request('GET', 'https://jsonplaceholder.typicode.com/users').then((res) => {
	...
	it('GET api test /todos', () => {
		cy.request('GET', 'https://jsonplaceholder.typicode.com/todos').then((res) => {
